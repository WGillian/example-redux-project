...
const initialState = {
  ...
  beersLoading: false,
  food: '',
  alcoholContentOptions: [{ value: 2, label: 'Less than 2%' }, { value: 5, label: 'Less than 5%' }, { value: 10, label: 'Less than 10%' }, { value: 11, label: 'Above 10%' }],
  selectedAlcoholContent: -1,
  selectedMalt: { value: -1, label: 'All' },
  maltOptions: [
